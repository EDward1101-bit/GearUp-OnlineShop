...
namespace OnlineShopProject_dNet.Migrations
{
    ...
    [Migration("20260111203015_innitFinalModelDatabase")]
    partial class innitFinalModelDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShopProject_dNet.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShopProject_dNet.Models.FAQ", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShopProject_dNet.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShopProject_dNet.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShopProject_dNet.Models.Wishlist", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineShopProject_dNet.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineShopProject_dNet.Models.OrderDetail", b =>
                {
                    b.HasOne("OnlineShopProject_dNet.Models.Order", "Order")
            ...
            modelBuilder.Entity("OnlineShopProject_dNet.Models.Product", b =>
                {
                    b.HasOne("OnlineShopProject_dNet.Models.Category", "Category")
                        .WithMany("Products")
